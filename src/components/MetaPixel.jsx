...
const PIXEL_ID = '1177557606633622'

/**
 * @param {{ event: 'PageView' | 'Schedule' }} props
 */
export function MetaPixel({ event }) {
  const noscriptSrc =
    event === 'PageView'
      ? `https://www.facebook.com/tr?id=${PIXEL_ID}&ev=PageView&noscript=1`
      : `https://www.facebook.com/tr?id=${PIXEL_ID}&ev=Schedule&noscript=1`
