...
import { GOOGLE_BUSINESS, TESTIMONIALS } from '@/utils/siteData'
import { GoogleReviewsPanel } from '@/components/GoogleReviewsBadge'

export function Testimonials() {
  return (
    <section id="testimonials" className="border-t border-neutral-100 bg-gradient-to-b from-neutral-50 to-white py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-[#E64646]">Customer Reviews</p>
          ...
          <p className="mx-auto mt-3 max-w-2xl text-lg text-neutral-600">
            Join{' '}
            <span className="font-semibold text-neutral-900">{GOOGLE_BUSINESS.reviewCountLabel} homeowners</span>{' '}
            who&apos;ve rated us on Google — plus stories from across Middle Tennessee and North Alabama.
          </p>
        </div>
